...
// ============================================================
//
// The container tests formerly here exercised the plain alias templates that
// used to live in ct_string_view.hpp. Those aliases are gone, superseded by
// the wrapper class templates in <ct_str/ctsv_containers.hpp>, and their
// tests have moved (and grown considerably) into:
//
//     tests/ctsv_comparators_tests.cpp   -- concepts + comparators + hashers
//     tests/ctsv_containers_tests.cpp    -- the four container wrappers
